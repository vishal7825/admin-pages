...
<!DOCTYPE html>
    <html >
     <head>
        <title>Agri-Bizz : Welcome Profile</title>
        <meta charset="utf-8" />
    ...
    <body>
        ...
        <section id="banner" class="wrapper" style="font-family: 'Balsamiq Sans', cursive;">
            <div class="container">
                <header class="major">
                    <h2 style="font-family: 'Balsamiq Sans', cursive;">Welcome</h2>
                </header>
                <p>
                <?php
