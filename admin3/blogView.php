...
<html>
	...
	<body class="subpage">
		...
		?>
			...
			<section id="main" class="wrapper" style="background:#e8f1f2">
				<div class="inner">
					...
					<div class="row uniform">
						...
						<div class="3u 12u$(small)">
							<a href="bloglist.php" class="button special fit" style="background:#022708; float:"><span class="glyphicon glyphicon-book "></span> Read a Blog</a>
					
						</div>
						
						<div class="3u 12u$(small)" style="font-family: 'Akaya Telivigala', cursive; ">
							
							<a href="blogWrite.php" class="button special fit" style="background:#022708"><span class="glyphicon glyphicon-pencil "></span> Write a Blog</a>
						</div>
					</div>
					<br />
					<?php
						...
						<form method="post" action="blogView.php">
							<div class="row">
								<div class="6u 12u$(xsmall)">
									<button class = "button special small" name="<?php echo 'like'.$id; ?>" style="background:#022708" >
								...
								<div class="12u$">
									<center>
									<br>
									<input type="submit" name="<?php echo 'submit'.$id; ?>" class="button special small" value="Submit" style="background:#022708"/>
									</center>
								</div>
							</div>
						</form>
