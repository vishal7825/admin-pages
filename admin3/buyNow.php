<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        ...
        $sql = "INSERT INTO transaction (bid, pid, name, city, mobile, email, quantity, addr)
                VALUES ('$bid', '$pid', '$name', '$city', '$mobile', '$email', '$quantity', '$addr')";
...
<html>
<head>
	<title>Agri-Bizz : Transaction</title>
	<meta lang="eng">
