	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2 style="font-family: 'Balsamiq Sans', cursive; margin-top:-80px;">Your Product Our Market</h2>
				<p style="font-family: 'Ubuntu', sans-serif;">Where sellers meets buyers!!</p>
				<br><br>
				<center>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2 style="font-family: 'Balsamiq Sans', cursive;">Agri-Bizz</h2>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Agri-Bizz &copy; </h3>
			<br />
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">100100, Kiama Street<span>Nairobi, Kenya</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">+254 707 692 064</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:detahmarren7@gmail.com" style="color:white">info@agri_bizz.co.ke</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Agri-Bizz</b></span>
				Agri-Bizz is e-commerce trading platform for grains & groceries...
			</p>
